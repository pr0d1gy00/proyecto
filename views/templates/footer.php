<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <h3 class="footer__logo texto-fluido texto-degradado">
                            &#60;DevWebCamp />
            </h3>
            <p class="footer__texto">
                Devwebcamp es una conferencai para desarrolladores de todos los niveles y se lleva a cabo de forma presencial y en linea
            </p>
        </div>
    ...
    <p class="footer__copyright">
        ...
        <span class="footer__copyright--regular">
            -Todos los derechos reservador <?php echo date('Y');?>
        </span>
    </p>
</footer>